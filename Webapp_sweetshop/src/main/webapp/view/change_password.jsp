...
<section class="d-flex justify-content-center" style="margin-top: 32px;">
    <div class="login-container">
        ...
        <form action="change_password" method="post" class="login-form" onsubmit="return validateRegister(event)" novalidate>
            <div class="mb-3">
            ...
            <div class="mb-4">
                ...
                <div class="input-group">
                    <span class="input-group-text"><i class="fas fa-lock"></i></span>
                    <input type="password" class="form-control" value="${password == null ? "" : password}"
                           id="repeat__password" name="repeat_password"
            ...
            <button type="submit" name="btnRegister" value="btnRegister"
                    class="btn-login w-100 p-2" style="border-radius: 5px">Change password
            </button>
        </form>
