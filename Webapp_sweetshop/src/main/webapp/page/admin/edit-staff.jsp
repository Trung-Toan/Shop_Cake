...
<head>
    ...
    <link rel="canonical" href="/edit-staff.jsp" />
            ...
            <ul class="sidebar-nav">
                ...
                <li class="sidebar-item active">
                    ...
                    <ul id="pages" class="sidebar-dropdown list-unstyled collapse show " data-bs-parent="#sidebar">
                        <li class="sidebar-item active"><a class="sidebar-link" href="/getstaff">List Staffs</a></li>
                            ...
                            <div class="tab-pane fade show active" id="account" role="tabpanel">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <form id="staffForm" enctype="multipart/form-data" method="POST" action="/updatestaff">
                                            <div class="row">
                                                <div class="col-md-8">
                                                    <!-- Staff ID (Read-only) -->
                                                    <div class="mb-3">
                                                        <label for="id">ID:</label>
                                                        <input type="text" class="form-control" id="id" name="id" value="${staff.id}" readonly>
                                                    </div>

                                                    <div class="mb-3">
                                                        <label for="fullname">Full Name:</label>
                                                        <input type="text" class="form-control" id="fullname" name="myname" placeholder="Full Name"
                                                               value="${staff.fullName != null ? staff.fullName : ''}" oninput="validateField('fullname')">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="date" class="form-control" id="dob" name="dob" placeholder="Date Of Birth"
                                                               value="${staff.dob != null ? staff.dob : ''}" oninput="validateField('dob')">
                                                ...
                                                <div class="mb-3 col-md-6">
                                                    ...
                                                    <select id="status" name="status" class="form-control" data-style="py-0" onchange="validateField('status')">
                                                        ...
                                                        <option value="0" ${staff.status == 0 ? 'selected' : ''}>Disable</option>
                                                    </select>
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="mobno" name="mobno" placeholder="Mobile Number"
                                                           value="${staff.phone != null ? staff.phone : ''}"  oninput="validateField('mobno')">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="address" name="address" placeholder="Address"
                                                           value="${staff.address != null ? staff.address : ''}" oninput="validateField('address')">
                                                ...
                                                <div class="mb-3 col-md-6">
                                                    ...
                                                    <input type="email" class="form-control" id="email" name="email" placeholder="Email"
                                                           value="${staff.email != null ? staff.email : ''}" oninput="validateField('email')">
                                                ...
                                                <div class="mb-3 col-md-6">
                                                    ...
                                                    <input type="text" class="form-control" id="uname" name="uname" placeholder="User Name"
                                                           value="${staff.username != null ? staff.username : ''}" oninput="validateField('uname')">
                                                ...
                                                <div class="mb-3 col-md-6">
                                                    ...
                                                    <input type="text" class="form-control" id="createdAt" name="createdAt"
                                                           value="${staff.createdAt != null ? staff.createdAt : ''}" readonly>
                                                </div>
                                                ...
                                                <div class="mb-3 col-md-6">
                                                    ...
                                                    <input type="text" class="form-control" id="updatedAt" name="updatedAt"
                                                           value="${staff.updatedAt != null ? staff.updatedAt : ''}" readonly>
                                                </div>
                                            </div>
